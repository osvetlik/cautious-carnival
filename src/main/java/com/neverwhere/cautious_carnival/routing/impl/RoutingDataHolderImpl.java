...
public class RoutingDataHolderImpl implements RoutingDataHolder {
	...
	private final AtomicReference<Map<String, Map<String, String>>> routingDataRef = new AtomicReference<>();
	...
	@Override
	public void setRoutingData(Map<String, Map<String, String>> routingData) {
